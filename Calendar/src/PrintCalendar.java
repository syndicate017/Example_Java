...
public class PrintCalendar {
    public static void main(String[] args) {
        ...
        System.out.print("Enter the Full Year (e.g., 2012): ");
        ...
        if (year < 1800 || month < 1 && month > 12) {
            System.out.println("Invalid input! Please enter the Year and Month Correctly.");
        }
        else {
    ...
    public static void printMonth(int year, int month) {
        ...
        printMonthTittle(year, month);

        /*Print the body of the calendar*/
        printMonthBody(year, month);
    }

    /*Print the month tittle, e.g., March 2012*/
